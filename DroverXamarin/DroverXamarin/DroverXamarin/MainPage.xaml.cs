...
namespace DroverXamarin
{
    public partial class MainPage : ContentPage
    {
        ...
        //Function that hides slide out menu when called
        public async void onButtonClicked(object sender, EventArgs e)
		{
			drawer_button.IsVisible = !drawer_button.IsVisible;
			if (view.IsVisible == true)
			{
				view_box.FadeTo(0, 260);
				parentLayout.TranslateTo(0, 0, 250, Easing.SinIn);
		...
		//Reset the main page GUI to its default state
