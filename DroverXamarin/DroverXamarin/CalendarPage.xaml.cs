...
namespace DroverXamarin
{
	public partial class CalendarPage : ContentPage
	{
		...
		public void monthChanged(DateTime new_date)
		{
			...
			// Updates the calendar to a whole new month
			...
			// Get the first day of the first week of the new month and set the first day to it
			...
			// Read all rides from the new month from the database and populate the rides variable
			...
			// For every day, setup each calendar cell to correspond with information stored in the database
		...
		{
			// Changes the date color of the background to gray or transparent
		...
		{
			// Adds a ride marker to the cell on the date grid that represents a specific day
		...
		{
			// Removes a ride marker from the cell that represents a specific day
			date_grid.Children.Remove(day);
		}
	}
}
